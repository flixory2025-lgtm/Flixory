...
const shortsData: Short[] = [
  {
    id: "43",
    title: "backbancher",
    youtubeId: "iYDAWtb8aAw", // Fixed: was "iYDAWtb8aA"
    likes: 3200,
    comments: 156,
    telegramLink: "https://t.me/flixoryproxy/2916",
  },
...
export function ShortsSection() {
  ...
  useEffect(() => {
    ...
    const indicesToLoad = [currentIndex - 2, currentIndex - 1, currentIndex, currentIndex + 1, currentIndex + 2].filter(
      (idx) => idx >= 0 && idx < shortsData.length,
    )
    ...
    indicesToLoad.forEach((index) => {
      ...
      setLoadingPlayers((prev) => new Set(prev).add(short.id))
        ...
        {shortsData.map((short, index) => (
          ...
          >
            <div className="relative w-full h-full" onClick={handleVideoClick}>
              ...
              {index === currentIndex && loadingPlayers.has(short.id) && (
              ...
              {index === currentIndex && !isPlaying && !loadingPlayers.has(short.id) && (
