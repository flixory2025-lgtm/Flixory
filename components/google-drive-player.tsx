  ...
  const skipBackward = () => {
    ...
    try {
      ...
      if (iframe && iframe.contentWindow) {
        // Google Drive iframe er sathe communicate korar try kori
        // Ei method Google Drive player e kaj kore
        ...
        // Iframe er document e event dispatch kori
        iframe.contentWindow.document.dispatchEvent(seekBackEvent)
        
        console.log("[v0] Sent skip backward command to Google Drive")
      }
    } catch (error) {
  ...
  const skipForward = () => {
    ...
    try {
      ...
      if (iframe && iframe.contentWindow) {
        ...
        console.log("[v0] Sent skip forward command to Google Drive")
      }
    } catch (error) {
      console.log("[v0] Could not send seek command to Google Drive iframe")
    }
